...
Proof Burrower a harassment-free experience for everyone, regardless of
...
. The hyperpolymath will review the report
...
The hyperpolymath will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different hyperpolymath member than the
original
...
* Open a
https://github.com/hyperpolymath/proof-burrower/discussions[Discussion]
