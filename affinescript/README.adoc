...
**Status sync (2026-04-12):** This section is aligned with `.machine_readable/STATE.a2ml`.
...
* Keep `README`, `ROADMAP`, `COMPILER-CAPABILITIES`, and `.machine_readable/STATE.a2ml` synchronized on each feature milestone.
