...
*MPL-2.0* - Palimpsest Mutual Public License - Covers: Compiler,
tooling, standard library - Permissive with ethical use requirements -
...
https://github.com/hyperpolymath/gossamer (MPL-2.0) - Burble:
https://github.com/hyperpolymath/burble (MPL-2.0)
