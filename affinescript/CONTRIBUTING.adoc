...
git clone https://github.com/hyperpolymath/proof-burrower.git cd
proof-burrower
...
toolbox create proof-burrower-dev toolbox enter proof-burrower-dev #
...
proof-burrower/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
