...
| **Bun** | Runtime & package management | Estate JavaScript runtime |
...
2. **Use Bun for JavaScript dependencies** - Record them in package.json with bun.lock
3. **Use locked installs** - Run bun install --frozen-lockfile in CI
...
- **JS deps**: Bun (package.json and bun.lock)
