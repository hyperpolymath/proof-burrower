...
Tree-sitter grammar for AffineScript - affine types, effects, and
dependent types.
...
Syntax highlighting for: - Keywords (fn, let, type, effect, etc.) -
Effects and effect operators - Types and type parameters - Functions and
function calls - Literals and comments

==== Locals (planned)

Scope analysis for: - Variable definitions and references - Function
scopes - Block scopes

==== Injections (planned)

Language injections for: - Inline documentation - String interpolation
