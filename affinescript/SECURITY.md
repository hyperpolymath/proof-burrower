...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/proof-burrower/security/advisories/new)
...
- This repository (`hyperpolymath/proof-burrower`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/proof-burrower/security/advisories)
...
When using Proof Burrower, we recommend:
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/proof-burrower/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/proof-burrower/discussions) |
...
*Thank you for helping keep Proof Burrower and its users safe.* 🛡️
