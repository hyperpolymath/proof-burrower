...
This is the first public release of AffineScript, featuring a complete
specification and reference parser.

=== What’s Included

==== Specification

* `+SPEC.md+` - Condensed language specification (essential grammar and
semantics)
...
* `+examples/vectors.affine+` - Dependent types with length-indexed
vectors
