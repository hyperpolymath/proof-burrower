...
This directory will contain the mechanized Coq proof development for
...
We use: 1. *Locally nameless* representation for binding 2.
*Intrinsically-typed syntax* where practical 3. *Small-step semantics*
for operational behavior 4. *Logical relations* for semantic properties
...
. MetaCoq documentation
. Iris Proof Mode documentation
. RustBelt Coq development
