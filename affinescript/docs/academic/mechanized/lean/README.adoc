...
This directory will contain the mechanized Lean 4 proof development for
...
[arabic]
. *Decidable type checking*: Can compute types
. *Metaprogramming*: Powerful tactic framework
. *Performance*: Compiled tactics
. *Interoperability*: Can call external tools
